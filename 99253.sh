...
sed -i "3i uci set network.lan.ipaddr='192.168.99.253'" ./package/lean/default-settings/files/zzz-default-settings
...
sed -i "8i uci set network.lan.gateway='192.168.99.254'" ./package/lean/default-settings/files/zzz-default-settings  # 默认网关地址（主路由 IP）
