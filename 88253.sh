...
sed -i "3i uci set network.lan.ipaddr='192.168.88.253'" ./package/lean/default-settings/files/zzz-default-settings
...
sed -i "8i uci set network.lan.gateway='192.168.88.254'" ./package/lean/default-settings/files/zzz-default-settings  # 默认网关地址（主路由 IP）
sed -i "9i uci set network.lan.dns='192.168.88.2'" ./package/lean/default-settings/files/zzz-default-settings  # 默认上游 DNS 地址
